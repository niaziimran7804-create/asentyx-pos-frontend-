...
let OrdersComponent = class OrdersComponent {
    ...
    orderPaymentStatus = 'Pending'; // Payment status for new orders
    // Customer search
    customerSearchTerm = '';
    ...
    expandedOrderIds = new Set(); // Track expanded multi-product orders
    ...
    constructor(orderService, productService, invoiceService, authService) {
    ...
    updateOrderStatus() {
        if (!this.selectedOrderForUpdate)
            return;
