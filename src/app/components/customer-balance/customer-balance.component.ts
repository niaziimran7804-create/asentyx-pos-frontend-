...
import { CustomerBalanceDto } from '../../models/customer-balance.models';
...
export class CustomerBalanceComponent implements OnInit {
  ...
  filteredBalances: CustomerBalanceDto[] = [];
  searchTerm: string = '';
  areaSearchTerm: string = '';
  
  // Totals
  totalDays0To30: number = 0;
  totalDays31To60: number = 0;
  totalDays61To90: number = 0;
  totalDays91Plus: number = 0;
  grandTotal: number = 0;
  ...
  get paginatedBalances(): CustomerBalanceDto[] {
